...
public class WideOnlyPath extends SequentialCommandGroup {
    public WideOnlyPath(SwerveSubsystem swerveSubsystem, ArmSubsystem armSubsystem, GripperSubsystem gripperSubsystem, Pneumatics pneumatics) {
