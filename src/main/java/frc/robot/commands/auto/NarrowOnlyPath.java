...
public class NarrowOnlyPath extends SequentialCommandGroup {
    public NarrowOnlyPath(SwerveSubsystem swerveSubsystem, ArmSubsystem armSubsystem, GripperSubsystem gripperSubsystem, Pneumatics pneumatics) {
