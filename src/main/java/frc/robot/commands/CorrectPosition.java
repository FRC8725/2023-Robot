...
public class CorrectPosition extends CommandBase {
    ...
    public CorrectPosition(SwerveSubsystem swerveSubsystem, AprilTag aprilTag, int whereChase) {
        // 0 stand for left side
        // 1 stand for middle
        // 2 stand for right side
        ...
        addRequirements(swerveSubsystem, aprilTag);
    ...
    @Override
    public void execute() {
        Transform3d relativePos = aprilTag.getAprilTagRelative();
